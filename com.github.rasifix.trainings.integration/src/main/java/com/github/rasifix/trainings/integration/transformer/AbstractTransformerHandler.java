...
public abstract class AbstractTransformerHandler implements MessageHandler {

	protected SubscribableChannel inputChannel;
	protected MessageChannel outputChannel;

	public void setInputChannel(SubscribableChannel inputChannel) {
